...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("It was not supposed to be :)", black, 210, 250)
        text_screen("Press __SPACE__ Bar To Play", black, 190, 310)
    ...
    while not exit_game:
        if game_over:
            ...
            if abs(snake_x - food_x)<10 and abs(snake_y - food_y)<10:
                ...
                # velocity_x = velocity_x + 5
                # velocity_y = velocity_y + 5
